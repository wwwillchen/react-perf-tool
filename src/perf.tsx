...
const ComponentView = (props: ComponentViewProps) =>
  ...
  >
    ...
    <span style={BodyStyle}>{props.perf.totalTimeSpent}</span>
    <span style={BodyStyle}>{props.perf.percentTimeSpent}</span>
    <ComponentTimingView
      name={"render"}
...
const ComponentTimingView = (props: ComponentTimingViewProps) =>
  <span>
    <span style={BodyStyle}>{props.timing.numberOfTimes}</span>
    <span style={BodyStyle}>{props.timing.averageTimeSpentMs}</span>
    <span style={BodyStyle}>{props.timing.totalTimeSpentMs}</span>
  </span>;
